...
const effectCheck = object({ id: str, kind: enumeration('shot', 'impact', 'teleport', 'repair', 'destroyed', 'shield', 'warning'), sourceShipId: str, targetShipId: str, text: str, atMs: nonnegative, weaponId: optional(str), roomId: optional(str), mountIndex: optional(integer), flightMs: optional(nonnegative), delayMs: optional(nonnegative) });
