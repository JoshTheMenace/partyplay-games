import { COURSE_GUIDES } from './engine/course-features';
...
function Controls({ publicView: race, playerId, isHost, setInput, releaseInput, sendAction, connected }: Props) {
