...
import {botInput,createRace,stepRace,advanceCheckpoints,STEP,respawn} from '../src/engine/simulation';
import {TRACKS,sample,surfaceFrame,magneticAt} from '../src/engine/tracks';
