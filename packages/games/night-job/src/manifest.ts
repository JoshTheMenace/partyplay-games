...
export const manifest = {
  contractVersion: '1.0', id: 'night-job', title: 'Night Job', description: 'Case the joint. Grab the goods. Get your whole crew out. Three pixel-art heists for one to four thieves.',
