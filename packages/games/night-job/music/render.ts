/** Renders Night Job music. Usage (platform root): node --import tsx packages/games/night-job/music/render.ts <outDir> [track-id…] */
...
const [out = 'output/night-job-music', ...only] = process.argv.slice(2);
