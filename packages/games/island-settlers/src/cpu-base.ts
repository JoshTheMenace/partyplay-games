/** CPU decisions use only public information and this seat’s private view. */
import { COSTS, RESOURCES, emptyHand, type Action, type Hand, type PrivateView, type PublicView } from './model';
