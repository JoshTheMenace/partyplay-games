...
import { activateItem, hit, ITEM_IDS, ITEMS, selectItem, tickStatuses, updateHazards } from '../game/items';
import { createRace, stepRace } from '../game/simulation';
import { nearest, roadHeight, sample, TRACKS } from '../game/tracks';
import { NEUTRAL, type Item, type Racer } from '../game/types';
