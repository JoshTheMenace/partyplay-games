...
import { createRace, STEP, stepRace, botInput } from '../game/simulation';
import { DRIVERS, MAX_PLAYERS, DEFAULT_GRID_SIZE } from '../game/types';
import { viewportRect } from '../game/split-screen';
import { TRACKS } from '../game/tracks';
import type { TrackId } from '../game/types';
import { createKart } from '../game/kart';
import { disposeObject } from '../game/dispose';
import { readPreferences } from '../game/preferences';
